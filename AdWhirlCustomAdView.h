...
{
  id<AdWhirlCustomAdViewDelegate> __weak delegate;
  UIImage *image;
  UILabel *textLabel;
  NSURL *__weak redirectURL;
  NSURL *__weak clickMetricsURL;
...
@property (nonatomic,weak) id<AdWhirlCustomAdViewDelegate> delegate;
@property (nonatomic,strong) UIImage *image;
@property (nonatomic,readonly) UILabel *textLabel;
@property (weak, nonatomic,readonly) NSURL *redirectURL;
@property (weak, nonatomic,readonly) NSURL *clickMetricsURL;
