...
@interface AdWhirlAdNetworkAdapter : NSObject {
  id<AdWhirlDelegate> __weak adWhirlDelegate;
  AdWhirlView *__weak adWhirlView;
...
@property (nonatomic,weak) id<AdWhirlDelegate> adWhirlDelegate;
@property (nonatomic,weak) AdWhirlView *adWhirlView;
